<%@ page import="ru.meldren.weblab2.database.Result" %>
<%@ page import="ru.meldren.weblab2.Constant" %>
<%@ page import="java.util.List" %>
<%@ page import="ru.meldren.weblab2.database.InfluxDatabase" %>
<%@ page import="static ru.meldren.weblab2.Constant.isOnPlot" %>
...
<div class="result_table">
    <table>
        ...
        <tbody id="output">
        <%
            InfluxDatabase database = ((InfluxDatabase) application
                    .getAttribute(Constant.DATABASE_ATTRIBUTE));
            for (Result result : database.getElementsByPage(1)) {
                out.println(result);
            }
        %>
        </tbody>
    ...
    <div class="table_buttons">
        <div class="left_buttons">
            <button id="first_page_button" type="button">Первая страница</button>
            <button id="previous_page_button" type="button">Предыдущая страница</button>
        </div>
        <div class="right_buttons">
            <button id="next_page_button" type="button">Следующая страница</button>
            <button id="last_page_button" type="button">Последняя страница</button>
        </div>
    </div>
</div>
<div class="footer">
